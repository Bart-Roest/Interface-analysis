...
This repository provides two core scripts: interface_batch_analysis and plot_interface_results, the scripts are designed to analyze and visualize the molecular interactions between a protein binder and its target. These tools automate the evaluation of protein-protein complexes using structural data.interface_batch_analysis: Extracts interaction data from a batch of structures based on user-defined hotspot residues.plot_interface_results: Generates visual plots of the interaction profiles to help identify key binding trends. To use these scripts, you will need:.pdb files: Structural files of your (predicted) protein-protein complexes (e.g., from AlphaFold-Multimer, ESMFold, or experimental data).Python 3.x with required dependencies (e.g., biopython, matplotlib, pandas, seaborn).
